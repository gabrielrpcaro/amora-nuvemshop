                ...
                <div class="col-12">
                    <div class="js-swiper-related swiper-container">
                        ...
                        {% endif %}
                            ...
                            <div class="js-swiper-related-prev swiper-button-prev"><img class="flecha-reversa" src="{{ "images/flecha.png" | static_url }}"></div>
                            <div class="js-swiper-related-next swiper-button-next"><img class="flecha" src="{{ "images/flecha.png" | static_url }}"></div>
                        {% if related_products | length < 4 %}
                        </div>
                        {% endif %}
                    </div>

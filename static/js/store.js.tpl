...
$(document).ready(function(){
	...
	function changeVariant(variant){
	    ...
	    if (variant.price_short){
	        parent.find('.js-price-display').html("<span class='dinheiro'>R$</span><span class='variado'></span>");
            parent.find('.variado').text(variant.price_number);
            parent.find('.js-price-display').show();
